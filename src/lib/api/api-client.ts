...
export class ApiClient {
  ...
  ): Promise<ApiResponse<{ id: string; schedule: any }>> {
  ...
  static async getScheduledScans(): Promise<ApiResponse<Array<{ id: string; schedule: any; scan: ScanResult }>>> {
    return this.request("/scans/scheduled");
  }
  ...
  // Webhooks
  static async createWebhook(url: string, events: string[]): Promise<ApiResponse<{ id: string; url: string; events: string[] }>> {
  ...
  static async getWebhooks(): Promise<ApiResponse<Array<{ id: string; url: string; events: string[] }>>> {
    return this.request("/webhooks");
  }
  ...
  // Team collaboration
  static async getTeams(): Promise<ApiResponse<Array<{ id: string; name: string; members: any[] }>>> {
...
export class LocalStorageApiClient {
  ...
  static async getScheduledScans(): Promise<any[]> {
    const data = localStorage.getItem(this.SCHEDULED_SCANS_KEY);
    return data ? JSON.parse(data) : [];
  }

  static async saveScheduledScan(schedule: any): Promise<void> {
  ...
  static async saveWebhook(webhook: any): Promise<void> {
